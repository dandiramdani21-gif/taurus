...
interface Voucher {
  ...
  stock: number;
  image: string | null;
  // note?: string;      // kalau ada note bisa ditambahkan nanti
}
...
export default function KasirVoucherPage() {
  ...
  const addToCart = (product: Voucher) => {
    if (product.stock <= 0) {
      alert("Stok habis!");
      return;
    }
    ...
    <div className="flex flex-col lg:flex-row gap-6 p-4 md:p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex-1">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <h1 className="text-3xl font-semibold text-gray-900">Kasir Voucher</h1>
          <input
            type="text"
              ...
              <table className="w-full min-w-[700px]">
                <thead className="bg-gray-50 sticky top-0">
                  <tr>
                    ...
                    <th className="px-4 py-4 text-left">Nama Voucher</th>
